...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description = 'A tool for running MI calculation based on two UniProt IDs.')
    parser.add_argument('-A', action = "store", dest = "UniProtID_01", help = "The UniProt ID for the first protein.")
    parser.add_argument('-B', action = "store", dest = "UniProtID_02", help = "The UniProt ID for the second protein.")
...
'''
    ...
    python MI_coevolution_2IDs.py -A Q9Y3B2 -B Q9Y3B7
